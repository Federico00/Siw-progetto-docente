package com.example.catering.autentication;
...
import static com.example.catering.model.Credentials.ADMIN_ROLE;
...
public class AuthConfiguration extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/", "/index", "/home",  "/chefAll/**", "/ingredienteAll/**","/buffetAll/**", "/piattoAll/**", 
                ...
                // login paragraph: qui definiamo come ̬ gestita l'autenticazione
